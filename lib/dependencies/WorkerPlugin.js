...
/** @typedef {import("../../declarations/WebpackOptions").WorkerChunkFilename} WorkerChunkFilename */
...
class WorkerPlugin {
	 ...
	 * @param {WorkerChunkFilename=} workerChunkFilename worker chunk filename
	 */
	constructor(
		chunkLoading,
		wasmLoading,
		...
		this._workerChunkFilename = workerChunkFilename;
	}
					...
					const handleNewWorker = expr => {
						...
						const block = new AsyncDependenciesBlock({
							...
							entryOptions: {
								...
								filename: entryOptions.filename
									? entryOptions.filename
									: this._workerChunkFilename,
								...entryOptions
							}
						});
						block.loc = expr.loc;
